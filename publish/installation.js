...
var dimx_inputs = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
});

unwrapExports(dimx_inputs);

var genericResource$1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
});
                    ...
                    uuid: (addonUUID) => {
                        return {
                            table: (tableName) => {
                                return {
                                    upsert: async (body) => {
                                        return await this.service.post(`/addons/data/import/file/${addonUUID}/${tableName}`, body);
                                    },
                                };
                            },
                        };
                        ...
                        uuid: (addonUUID) => {
                            return {
                                table: (tableName) => {
                                    return {
                                        upsert: async (body) => {
                                            return await this.service.post(`/addons/data/import/file/recursive/${addonUUID}/${tableName}`, body);
                                        },
                                    };
                                },
                            };
                    ...
                    uuid: (addonUUID) => {
                        return {
                            table: (tableName) => {
                                return {
                                    get: async (body) => {
                                        return await this.service.post(`/addons/data/export/file/${addonUUID}/${tableName}`, body);
                                    },
                                };
                            },
                        };
                        ...
                        uuid: (addonUUID) => {
                            return {
                                table: (tableName) => {
                                    return {
                                        get: async (body) => {
                                            return await this.service.post(`/addons/data/export/file/recursive/${addonUUID}/${tableName}`, body);
                                        },
                                    };
                                },
                            };
            ...
            search: (dslQuery) => {
                return {
                    uuid: (addonUUID) => {
                        return {
                            resource: async (resourceName) => {
                                return await this.service.post(`/addons/index/search/${addonUUID}/${resourceName}`, dslQuery);
                            },
                        };
                    },
                };
            ...
            delete: (dslQuery) => {
                return {
                    uuid: (addonUUID) => {
                        return {
                            resource: async (resourceName) => {
                                return await this.service.post(`/addons/index/delete/${addonUUID}/${resourceName}`, dslQuery);
                            },
                        };
                    },
                };
            ...
            update: (dslQuery) => {
                return {
                    uuid: (addonUUID) => {
                        return {
                            resource: async (resourceName) => {
                                return await this.service.post(`/addons/index/update/${addonUUID}/${resourceName}`, dslQuery);
                            },
                        };
                    },
                };
                        ...
                        uuid: (addonUUID) => {
                            return {
                                resource: (resourceName) => {
                                    return {
                                        create: async (body) => {
                                            return await this.service.post(`/addons/shared_index/index/${indexName}/${addonUUID}/${resourceName}`, body);
                                        },
                                        key: (key) => {
                                            return {
                                                get: async () => {
                                                    return await this.service.get(`/addons/shared_index/index/${indexName}/${addonUUID}/${resourceName}/${key}`);
                                                },
                                            };
                                        },
                                        find: async (params) => {
                        ...
                        search: (dslQuery) => {
                            return {
                                uuid: (addonUUID) => {
                                    return {
                                        resource: async (resourceName) => {
                                            return await this.service.post(`/addons/shared_index/index/${indexName}/search/${addonUUID}/${resourceName}`, dslQuery);
                                        },
                                    };
                                },
                            };
                        ...
                        delete: (dslQuery) => {
                            return {
                                uuid: (addonUUID) => {
                                    return {
                                        resource: async (resourceName) => {
                                            return await this.service.post(`/addons/shared_index/index/${indexName}/delete/${addonUUID}/${resourceName}`, dslQuery);
                                        },
                                    };
                                },
                            };
                        ...
                        update: (dslQuery) => {
                            return {
                                uuid: (addonUUID) => {
                                    return {
                                        resource: async (resourceName) => {
                                            return await this.service.post(`/addons/shared_index/index/${indexName}/update/${addonUUID}/${resourceName}`, dslQuery);
                                        },
                                    };
                                },
                            };
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.GenericResourceEndpoint = void 0;
const endpoint_1 = __importDefault(endpoint);
class GenericResourceEndpoint {
    ...
    async get(options = {}) {
        const query = endpoint_1.default.encodeQueryParams(options);
...
exports.GenericResourceEndpoint = GenericResourceEndpoint;
});

unwrapExports(genericResource);
genericResource.GenericResourceEndpoint;
...
var conversions = {};
var C__automation_automation_template_serverSide_node_modules_webidlConversions_lib = conversions;
...
var mappingTable$2 = /*#__PURE__*/Object.freeze({
	__proto__: null,
	'default': mappingTable$1
});

var mappingTable = getCjsExportFromNamespace(mappingTable$2);
...
var C__automation_automation_template_serverSide_node_modules_tr46 = {
	toASCII: toASCII,
	toUnicode: toUnicode,
...
function parseHost(input, isSpecialArg) {
  ...
  const asciiDomain = C__automation_automation_template_serverSide_node_modules_tr46.toASCII(domain, false, C__automation_automation_template_serverSide_node_modules_tr46.PROCESSING_OPTIONS.NONTRANSITIONAL, false);
  if (asciiDomain === null) {
    return failure;
  }
...
function URL(url) {
  ...
  args[0] = C__automation_automation_template_serverSide_node_modules_webidlConversions_lib["USVString"](args[0]);
  if (args[1] !== undefined) {
  args[1] = C__automation_automation_template_serverSide_node_modules_webidlConversions_lib["USVString"](args[1]);
  }
...
Object.defineProperty(URL.prototype, "href", {
  ...
  set(V) {
    V = C__automation_automation_template_serverSide_node_modules_webidlConversions_lib["USVString"](V);
    this[impl].href = V;
  },
  enumerable: true,
  configurable: true
