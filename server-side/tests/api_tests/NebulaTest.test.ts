...
import { GetRecordsRequiringSyncParameters, NebulaTestService } from "./services/nebulatest.service";
...
export async function NebulaTest(generalService: GeneralService, addonService: GeneralService, request, tester: TesterFunctions) {
    ...
    function buildGetRecordsRequiringSyncParameters(tableName: string, modificationDateTime: string, includeDeleted: boolean = false): GetRecordsRequiringSyncParameters {
        return {
